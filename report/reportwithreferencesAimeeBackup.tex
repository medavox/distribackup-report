...
\bibitem{Backups with the 3-2-1 rule} http://blog.wisefaq.com/2010/01/05/backups-with-the-3-2-1-rule/
  (accessed 25/06/2014)
  
\bibitem{cliffEffect} Tomáš Kratochvíl, Radim Štukavec,  "DVB-T Digital Terrestrial Television Transmission over Fading Channels",  Brno University of Technology (http://www.radioeng.cz/fulltexts/2008/08\_03\_096\_102.pdf) (accessed 20/03/2015)

\bibitem{Joey Hess} http://git-annex.branchable.com/ (Accessed 25/06/2014)

\bibitem{Tahoe-OPS}  https://tahoe-lafs.org/trac/tahoe-lafs/browser/trunk/docs/about.rst
  (accessed 24/06/2014)
  
\bibitem{sparkleshare} http://sparkleshare.org/ (accessed 25/06/2014)

\bibitem{SSGood} http://sparkleshare.org/\#good  (accessed 25/06/2014)

\bibitem{SSBad} http://sparkleshare.org/\#bad  (accessed 25/06/2014)

\bibitem{polishStuff} Dhiru Kholia and
...
\bibitem{Guardian} The Guardian, ``The NSA Files''
  (http://www.theguardian.com/world/the-nsa-files)(accessed 25/06/2014)
  
\bibitem{otherShit} ``Dropbox
  Privacy Policy'', (https://www.dropbox.com/privacy)(accessed
  25/06/2014)

\bibitem{HB} "The Heartbleed Bug" (http://heartbleed.com/) (accessed 20/03/2015)

\bibitem{MagMurph} Margi Murphy, ``Microsoft must hand over customer
...
\bibitem{kryo} "Kryo object graph serialization framework" (https://github.com/EsotericSoftware/kryo) (accessed 20/03/2015)

\bibitem{git} "Git Website" (http://git-scm.com/) (accessed 24/06/2014)
